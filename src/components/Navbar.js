            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-secondary position-sticky"
                ...
                <div className="container-fluid">
                    ...
                    <Link className="navbar-brand fs-1 fst-italic" to="/">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUegXW8iLqoQMYa-kqvhKITk021EfxGAiR0A&usqp=CAU" alt="Logo" width="50" height="50" className="mr-2 rounded-circle" />
                        The Indian Rasoi</Link>
